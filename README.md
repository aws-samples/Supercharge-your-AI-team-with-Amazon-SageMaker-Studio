...
- Download the postman app to make API call. Adjust postman configuration as described below.
  ...
  - Go to **'Environments'** tab in the Postman. You will see an envionment called 'SageMaker' from previous step. Add the below env variables which you would see as part of the stack deployment output from SagemakerLoginStack in console.
